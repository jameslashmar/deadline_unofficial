...
If you would like to install a basic Deadline Monitor on your Android, we now provide a legacy APK to do so.
...
```adb install --bypass-low-target-sdk-block Deadline_Mobile_1.2.apk```
