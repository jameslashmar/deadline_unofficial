...
class SubmitC4DToDeadlineDialog( gui.GeDialog ):
    ...
    def vray5_get_render_elements(self, scene, video_post):
        ...
        while channel_node:
            channel_data = channel_node.GetData()
                ...
                if not localExport:
                    ...
                    if EnableRegionRendering and SingleFrameTileJob and not exportJob:
                        ...
                        if useTakeFrames:
                            ...
                            endFrame = renderData.GetTime( c4d.RDATA_FRAMETO ).GetFrame( int(framesPerSecond) )#jusbla casting fps to int
